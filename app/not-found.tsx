  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <Link 
          href="/jobs" 
          className="bg-white border border-gray-300 text-foreground font-semibold px-8 py-3 rounded-md hover:bg-gray-50 transition-colors shadow-sm dark:bg-gray-900 dark:border-gray-700 dark:hover:bg-gray-800 flex items-center justify-center gap-2"
        >
