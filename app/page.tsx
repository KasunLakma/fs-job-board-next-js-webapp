            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent dark:bg-gray-800 dark:border-gray-700"
                />
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
            {[
              ...
              <Link
                ...
                className="group flex flex-col items-center p-8 rounded-xl border border-gray-200 bg-white hover:border-primary hover:shadow-lg transition-all dark:bg-gray-900 dark:border-gray-800"
              >
