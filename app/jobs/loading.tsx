      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
        ...
        <aside className="lg:col-span-1">
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
            ...
            <div className="space-y-6">
              {[1, 2, 3, 4].map((i) => (
                <div key={i}>
                  <div className="mb-2 h-4 w-20 animate-pulse rounded-md bg-gray-200 dark:bg-gray-800"></div>
        ...
        <div className="lg:col-span-3">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="flex flex-col justify-between rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
                <div>
                  <div className="mb-4 flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      <div className="h-12 w-12 shrink-0 animate-pulse rounded-xl bg-gray-200 dark:bg-gray-800"></div>
                      <div>
                        <div className="mb-2 h-5 w-32 animate-pulse rounded-md bg-gray-200 dark:bg-gray-800"></div>
                  ...
                  <div className="mb-4 flex flex-wrap gap-2">
                    {[1, 2].map((j) => (
                      <div key={j} className="h-6 w-16 animate-pulse rounded-full bg-gray-200 dark:bg-gray-800"></div>
                    ))}
                  </div>
                </div>
