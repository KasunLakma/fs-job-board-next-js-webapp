...
export default function JobNotFound() {
 ...
 <p className="text-lg text-gray-900 max-w-lg mb-10">
 We couldn't find this specific opportunity. The job posting may have expired, been filled, or was removed by the employer.
 </p>
 
 <div className="bg-gradient-to-br from-white to-gray-50 border border-primary/20 rounded-2xl p-8 max-w-2xl w-full mb-8 shadow-md">
 ...
 className="group flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:border-primary hover:bg-primary/5 transition-all bg-white shadow-sm hover:shadow-md"
 >
 <span className="font-semibold text-foreground group-hover:text-primary transition-colors">Frontend Roles</span>
 <span className="text-gray-900 group-hover:text-primary transition-colors">&rarr;</span>
 </Link>
 <Link 
 href="/jobs?q=backend" 
 className="group flex items-center justify-between p-4 rounded-xl border border-gray-200 hover:border-primary hover:bg-primary/5 transition-all bg-white shadow-sm hover:shadow-md"
 ...
 <Link 
 href="/" 
 className="text-gray-900 hover:text-primary transition-colors font-medium underline-offset-4 hover:underline"
 >
 Return to Homepage
 </Link>
 </div>
