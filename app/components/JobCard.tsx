...
export default function JobCard({ job }: JobCardProps) {
 ...
 <div className="flex h-full flex-col justify-between rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-primary/50 hover:shadow-md ">
 <div>
