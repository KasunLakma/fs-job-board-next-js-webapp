...
export default function JobListings({ jobs }: { jobs: Job[] }) {
 ...
 <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Recent Opportunities</h2>
 ...
 <div className="bg-card border border-border p-6 rounded-xl shadow-sm group-hover:shadow-md group-hover:border-primary/50 transition-all flex flex-col h-full">
 ...
 <span className="text-xs text-foreground/50">{job.postedAt}</span>
 </div>
 </div>
 </Link>
 ))}
