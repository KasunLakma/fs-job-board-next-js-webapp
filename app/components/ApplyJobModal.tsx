...
export default function ApplyJobModal({ 
 ...
 <button 
 onClick={handleClose}
 className="p-2 text-gray-900 hover:text-white rounded-full hover:bg-gray-800 transition-colors"
 aria-label="Close"
 >
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-2">
 <label htmlFor="linkedin" className="block text-sm font-medium text-gray-900">LinkedIn Profile</label>
 ...
 <div className="space-y-2">
 <label htmlFor="portfolio" className="block text-sm font-medium text-gray-900">Portfolio / Website</label>
 ...
 <div className="space-y-4">
 <div className="space-y-2">
 <label htmlFor="resume" className="block text-sm font-medium text-gray-900">Resume / CV <span className="text-red-500">*</span></label>
 ...
 <svg className="mx-auto h-12 w-12 text-gray-900" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
 ...
 <p className="text-xs text-gray-900 mt-1">PDF, DOC, DOCX up to 10MB</p>
 </div>
 </div>
 </div>
 <div className="space-y-2">
 <label htmlFor="coverLetter" className="block text-sm font-medium text-gray-900">Cover Letter</label>
 ...
 className="w-full rounded-md bg-primary px-4 py-3 text-sm font-bold text-primary-foreground shadow-md transition-all hover:bg-primary/90 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 "
 >
 Apply Now
 </button>
